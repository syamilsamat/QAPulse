...
- `Requirements.tsx`: add approve/reject actions + comment box, visible for any FA-track role or admin/cto. PM Dashboard's milestone cards get the same affordance for the UAT gate.
