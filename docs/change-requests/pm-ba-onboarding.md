...
- **New page** `artifacts/qm-pulse/src/pages/PmDashboard.tsx` at route `/pm-dashboard`.
...
- **New page** `artifacts/qm-pulse/src/pages/RequirementDetail.tsx` at route `/requirements/:id` — replaces "click a row → open edit modal" with a real detail view (see mockup shared in chat), containing:
