 ...
 */
export const getRequirement = async (id: number, options?: RequestInit): Promise<Requirement> => {
...
export const getGetRequirementQueryOptions = <TData = Awaited<ReturnType<typeof getRequirement>>, TError = ErrorType<unknown>>(id: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getRequirement>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
export function useGetRequirement<TData = Awaited<ReturnType<typeof getRequirement>>, TError = ErrorType<unknown>>(
 ...
 */
export const deleteRequirement = async (id: number, options?: RequestInit): Promise<void> => {
...
export const getDeleteRequirementMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteRequirement>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
 ...
 */
export const listTestCases = async (params?: ListTestCasesParams, options?: RequestInit): Promise<TestCase[]> => {
 ...
 */
export const createTestCase = async (testCaseInput: TestCaseInput, options?: RequestInit): Promise<TestCase> => {
 ...
 */
export const getTestCase = async (id: number, options?: RequestInit): Promise<TestCase> => {
 ...
 */
export const cloneTestCase = async (id: number, options?: RequestInit): Promise<TestCase> => {
...
export const getCloneTestCaseMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof cloneTestCase>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof cloneTestCase>>, TError,{id: number}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof cloneTestCase>>, {id: number}> = (props) => {
          const {id} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type CloneTestCaseMutationResult = NonNullable<Awaited<ReturnType<typeof cloneTestCase>>>
 ...
 * @summary Clone test case
 */
export const useCloneTestCase = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof cloneTestCase>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
 ...
 */
export const generateTestCasesWithAI = async (aIGenerateInput: AIGenerateInput, options?: RequestInit): Promise<AIGenerateResponse> => {
...
export const getGenerateTestCasesWithAIMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof generateTestCasesWithAI>>, TError,{data: BodyType<AIGenerateInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof generateTestCasesWithAI>>, TError,{data: BodyType<AIGenerateInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof generateTestCasesWithAI>>, {data: BodyType<AIGenerateInput>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type GenerateTestCasesWithAIMutationResult = NonNullable<Awaited<ReturnType<typeof generateTestCasesWithAI>>>
 ...
 * @summary Generate test cases using AI
 */
export const useGenerateTestCasesWithAI = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof generateTestCasesWithAI>>, TError,{data: BodyType<AIGenerateInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
 ...
 */
export const releaseTask = async (id: number, options?: RequestInit): Promise<Task> => {
...
export const getReleaseTaskMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof releaseTask>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof releaseTask>>, TError,{id: number}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof releaseTask>>, {id: number}> = (props) => {
          const {id} = props ?? {};
 ...
 * @summary Release (unassign) a task so anyone can pick it up
 */
export const useReleaseTask = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof releaseTask>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
...
export const assignTask = async (id: number,
    assignTaskBody: AssignTaskBody, options?: RequestInit): Promise<Task> => {
...
export const getAssignTaskMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof assignTask>>, TError,{id: number;data: BodyType<AssignTaskBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof assignTask>>, TError,{id: number;data: BodyType<AssignTaskBody>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof assignTask>>, {id: number;data: BodyType<AssignTaskBody>}> = (props) => {
          const {id,data} = props ?? {};
 ...
 */
export const listSocialEvents = async ( options?: RequestInit): Promise<SocialEvent[]> => {
...
export const getListSocialEventsQueryOptions = <TData = Awaited<ReturnType<typeof listSocialEvents>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listSocialEvents>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getListSocialEventsQueryKey();
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof listSocialEvents>>> = ({ signal }) => listSocialEvents({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listSocialEvents>>, TError, TData> & { queryKey: QueryKey }
}

export type ListSocialEventsQueryResult = NonNullable<Awaited<ReturnType<typeof listSocialEvents>>>
...
export function useListSocialEvents<TData = Awaited<ReturnType<typeof listSocialEvents>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listSocialEvents>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
 ...
 */
export const createSocialEvent = async (socialEventInput: SocialEventInput, options?: RequestInit): Promise<SocialEvent> => {
...
export const getCreateSocialEventMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createSocialEvent>>, TError,{data: BodyType<SocialEventInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof createSocialEvent>>, TError,{data: BodyType<SocialEventInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof createSocialEvent>>, {data: BodyType<SocialEventInput>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type CreateSocialEventMutationResult = NonNullable<Awaited<ReturnType<typeof createSocialEvent>>>
 ...
 * @summary Create a social/team hangout event
 */
export const useCreateSocialEvent = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createSocialEvent>>, TError,{data: BodyType<SocialEventInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
 ...
 */
export const updateSocialEvent = async (id: number,
    socialEventUpdate: SocialEventUpdate, options?: RequestInit): Promise<SocialEvent> => {
...
export const getUpdateSocialEventMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateSocialEvent>>, TError,{id: number;data: BodyType<SocialEventUpdate>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updateSocialEvent>>, TError,{id: number;data: BodyType<SocialEventUpdate>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateSocialEvent>>, {id: number;data: BodyType<SocialEventUpdate>}> = (props) => {
          const {id,data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UpdateSocialEventMutationResult = NonNullable<Awaited<ReturnType<typeof updateSocialEvent>>>
 ...
 * @summary Update a social event
 */
export const useUpdateSocialEvent = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateSocialEvent>>, TError,{id: number;data: BodyType<SocialEventUpdate>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
 ...
 */
export const deleteSocialEvent = async (id: number, options?: RequestInit): Promise<void> => {
...
export const getDeleteSocialEventMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteSocialEvent>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof deleteSocialEvent>>, TError,{id: number}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof deleteSocialEvent>>, {id: number}> = (props) => {
          const {id} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type DeleteSocialEventMutationResult = NonNullable<Awaited<ReturnType<typeof deleteSocialEvent>>>
 ...
 * @summary Delete a social event
 */
export const useDeleteSocialEvent = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteSocialEvent>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
 ...
 */
export const getTeamDashboard = async (params?: GetTeamDashboardParams, options?: RequestInit): Promise<TeamDashboard> => {
...
export const getGetTeamDashboardQueryKey = (params?: GetTeamDashboardParams,) => {
    return [
...
export const getGetTeamDashboardQueryOptions = <TData = Awaited<ReturnType<typeof getTeamDashboard>>, TError = ErrorType<unknown>>(params?: GetTeamDashboardParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getTeamDashboard>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetTeamDashboardQueryKey(params);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getTeamDashboard>>> = ({ signal }) => getTeamDashboard(params, { signal, ...requestOptions });
...
export function useGetTeamDashboard<TData = Awaited<ReturnType<typeof getTeamDashboard>>, TError = ErrorType<unknown>>(
 params?: GetTeamDashboardParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getTeamDashboard>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
...
export const getGetWeeklyTrendUrl = (params?: GetWeeklyTrendParams,) => {
  ...
  return stringifiedParams.length > 0 ? `/api/dashboard/weekly-trend?${stringifiedParams}` : `/api/dashboard/weekly-trend`
}

/**
 * @summary Get weekly trend data
 */
export const getWeeklyTrend = async (params?: GetWeeklyTrendParams, options?: RequestInit): Promise<WeeklyTrendPoint[]> => {
...
export const getGetWeeklyTrendQueryKey = (params?: GetWeeklyTrendParams,) => {
    return [
    `/api/dashboard/weekly-trend`, ...(params ? [params] : [])
    ] as const;
    }


export const getGetWeeklyTrendQueryOptions = <TData = Awaited<ReturnType<typeof getWeeklyTrend>>, TError = ErrorType<unknown>>(params?: GetWeeklyTrendParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getWeeklyTrend>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetWeeklyTrendQueryKey(params);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getWeeklyTrend>>> = ({ signal }) => getWeeklyTrend(params, { signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getWeeklyTrend>>, TError, TData> & { queryKey: QueryKey }
}

export type GetWeeklyTrendQueryResult = NonNullable<Awaited<ReturnType<typeof getWeeklyTrend>>>
...
export function useGetWeeklyTrend<TData = Awaited<ReturnType<typeof getWeeklyTrend>>, TError = ErrorType<unknown>>(
 params?: GetWeeklyTrendParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getWeeklyTrend>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
