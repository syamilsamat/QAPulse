...
<table width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
  <tr><td style="background:#274AB3;padding:22px 26px;">
    <div style="color:#a9c0ff;font-size:9pt;letter-spacing:2px;text-transform:uppercase;font-weight:bold;">QM Pulse &middot; Quality Management</div>
...
<p style="margin-top:30px;border-top:1px solid #e5e7eb;padding-top:8px;font-size:8.5pt;color:#9ca3af;">Generated by QM Pulse on ${generatedAt}. System-generated acceptance record — confidential to the project stakeholders.</p>
</body></html>`;
}
