...
// CR049 — every Verdict Report route requires an authenticated user. Without
// this, the email endpoints (/verdict-report/send-email, /verdict-report/
// send-verdict) let an anonymous caller send mail through the server, and
// the report/execution GETs leaked data.
...
router.get("/verdict-report/execution-details", async (req, res) => {
...
router.post("/verdict-report/execution-details", express.json(), async (req, res) => {
...
router.post("/verdict-report/send-email", async (req, res) => {
...
<body style="margin:0;padding:24px;background:#f3f4f6;font-family:Arial,sans-serif;">
  <div style="max-width:940px;margin:0 auto;">
    ...
    console.error("Verdict Report email send error:", err);
...
router.post("/verdict-report/send-verdict", express.json(), async (req, res) => {
